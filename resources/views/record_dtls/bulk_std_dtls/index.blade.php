                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-lg-1"></div>
                                  ...
                                  <div class="col-md-3">
                                    <input id="gender" type="numeric" class="form-control" name="female" value="{{$bulkStdList->female}}" disabled>
                           ...
                           <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input id="gender" type="numeric" class="form-control" name="male" value="{{$bulkStdList->male}}" disabled>
                           ...
                           <div class="panel-body">
                              ...
                              <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="age_btw_35_39yrs" type="numeric" class="form-control" name="age_btw_35_39yrs" value="{{$bulkStdList->age_btw_35_39yrs}}" disabled>

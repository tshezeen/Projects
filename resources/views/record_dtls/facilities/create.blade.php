                           ...
                           <div class="form-group"></div>
                            ...
                            <div class="col-md-3">
                                 ...
                                 <select name="facility_type_id" class="form-control"> 
                                        ...
                                        @foreach ($facilityType as $facilityType)
                                            <option value="{{$facilityType->id}}">{{$facilityType->facility_type}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-1"></div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="number" type="numeric" class="form-control" name="number"  placeholder="Total no. of such facility." required autofocus>
                           ...
                           <div class="form-group"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="capacity" type="numeric" class="form-control" name="capacity" placeholder="Capacity(persons) in each.">
